package com.aisino.carinsurance.util;
...
public class HttpUtil {
     ...
     * @throws Exception
     */
    public static void postRequestTest(String url, String json, final PostResposeListner listner){
        Log.v("url:",url);
        Log.v("json:",(json = (json == null? "": json)));
        //处理请求返回数据
        ...
        client.newCall(request).enqueue(new Callback(){
            ...
            public void onFailure(Call call, IOException e) {
                Log.v("post onFailure",e.toString());
